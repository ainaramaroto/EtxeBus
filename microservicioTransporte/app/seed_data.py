...
STOP_COORDINATES: dict[str, tuple[Decimal, Decimal]] = {
    ...
    "L1 Kukullaga Ikastetxea": _coord(-2.886034033873555, 43.248992351853026),
    "L1 Beheko San Antonio Hiribidea": _coord(-2.8874842700078407, 43.24717715469667),
    "L1 Doneztebe Eliza": _coord(-2.8912215474404075, 43.246038806411484),
    "L1 Metacal Kalea": _coord(-2.893827387294854, 43.24495873405763),
...
def seed_custom_schedule_rows(session: Session) -> None:
    for payload in CUSTOM_SCHEDULES:
        record = (
...
def seed_initial_data(session_factory) -> None:
    ...
    try:
        ...
        seed_custom_schedule_rows(session)
    finally:
        session.close()
