    ...
    schemas: {
      ...
      Preferencia: {
        ...
        properties: {
          ...
          paradaOrigen: { type: 'string', nullable: true, example: 'plaza-ayuntamiento' },
          paradaDestino: { type: 'string', nullable: true, example: 'metro-etxebarri' },
          nomParadaOrigen: { type: 'string', nullable: true, example: 'Plaza Ayuntamiento' },
          nomParadaDestino: { type: 'string', nullable: true, example: 'Metro Etxebarri' },
